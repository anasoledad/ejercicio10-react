...
const Formulario = () => {
    ...
    let peliculasLocalstorage = JSON.parse(localStorage.getItem('cardPeliculas')) || [];
    ...
    const handleSubmit = (e) => {
      ...
      const borrarPelicula = (nombrePeli)=>{
        let arregloFiltrado = datos.filter((cardPeli)=> cardPeli.nombre !== nombrePeli)
  ...
  return (
    <Container className="pt-4 pb-5 px-3 d-flex justify-content-center">
      <Col lg={8} className="border border-2 rounded-4 p-5 bgForm">
        <h4 className="mb-4">LLenar el formulario para registrar una película</h4>
        <hr />
        <Form onSubmit={handleSubmit}>
          <Form.Group className="mb-3" controlId="nombre">
            <Form.Label><strong>Nombre de Pelicula</strong></Form.Label>
            <Form.Control type="text" placeholder="Nombre de pelicula" value={nombre}
                onChange={(e) => handleInputChange(e, setNombre)}/>
          </Form.Group>
          <Form.Group className="mb-3" controlId="genero">
          <Form.Label><strong>Género</strong></Form.Label>
          <Form.Select aria-label="genero" value={genero} onChange={(e) => handleInputChange(e, setGenero)}>
          ...
          <Form.Group className="mb-3" controlId="descripcion">
            ...
            <Form.Control as="textarea" type="text" placeholder="Describir la película" value={descripcion}
